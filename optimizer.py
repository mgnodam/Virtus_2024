...
#prob.driver.options['run_parallel']= True                               # Só funciona se conseguir fazer o programa rodar no mpi, mas parece bem chato
...
# Adicionando o único objetivo atualmente (v03)
